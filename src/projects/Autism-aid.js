    ...
    return (
        <div className="Project">
            ...
            <Col xs={{offset: 1, size: 10}}>
                ...
                The code for this project can be found <a target="_blank" rel="noopener noreferrer" href="https://github.com/ChaseGHMU/ThompsonCenterApp">here.</a>
                <br />
                <br />
                <img src="autism-aid-project.png" alt="Autism Aid" width="100%" />
            </Col>
            <br />
            <br />
            <OtherWork />
